...
export const AddProduct = () => {
  ...
  console.log(product)
    try{
        ...
        const response = await axios.post("http://localhost:8080/byj/imagenesProductos", formData, {
          headers: {
  ...
  return (
    <div className="container AgregarProducto">
      ...
      <form style={{ width: "75%" }} class="row g-3 needs-validation mt-3" onSubmit={handleSubmit}>
        <div class="col-md-4">
          <label for="validationCustom01" class="form-label">
            Nombre del producto
          </label>
          <input type="text" class="form-control" id="nombreProduct" required value={product.nombre} onChange={(e)=>setProduct({...product, nombre: e.target.value})}/>
        ...
        <div class="col-md-3">
          ...
          <select class="form-select" id="validationCustom04" required onChange={obtenerCategoria}>
